...
os.environ["OPENAI_API_KEY"] = 'D' # 커밋할때 오류뜨니 바꿈
    ...
    messages=[
        {
            "role": "system",
            "content": (
                "당신은 감성적인 작가이자 심리상담사입니다. "
                "사용자의 감정을 섬세하게 분석하고, 따뜻한 말로 위로하는 글을 작성합니다. "
                "출력은 반드시 JSON 형식으로 아래 형식을 따릅니다:\n\n"
                "{\n"
                "  \"emotion\": \"우울 / 무기력 / 외로움 등 감정\",\n"
                "  \"diary\": \"하루를 위로하고 감싸주는 감성적인 글\"\n"
                "}"
            )
        },
        {
